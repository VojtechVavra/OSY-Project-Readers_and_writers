    ...
    while (1)
    {
        ...
        if (expected_message == FIRST_EXPECTED_MESSAGE)
        {
            ...
            if (msg.number == CI_PrichaziC && !strcmp(msg.text, CS_PrichaziC))
            {
                ...
                // 4. Muzes cist
                send_message(newSocket, MessageType::ANSWER, AI_Cti, AS_Cti);
            }
            // 9. prisel klient na psani
                ...
                // 12. Muzes psat
                send_message(newSocket, MessageType::ANSWER, AI_Pis, AS_Pis);
            } else {
                continue;
            }
        }
        // 13: cti od X do Y
            ...
            if (msg.number == CI_Cist) {
                ...
                send_message(newSocket, MessageType::ANSWER, AI_Data, AS_Data);
            } else {
                //printf("\nespravna zprava!\n");
                continue;
            }
        ...
        // 14: chci psat
            ...
            if (msg.number == CI_Psat) {
                ...
                // 14. send hotovo
                send_message(newSocket, MessageType::ANSWER, AI_Zapsano, AS_Zapsano);
            }
            else {
                continue;
            }
        ...
        // 15: Konec
            ...
            if (msg.number == CI_Konec && expected_message == CI_KONEC_CTENAR) {
                // 8. send naschledanou
                send_message(newSocket, MessageType::ANSWER, AI_Nashledanou, AS_Nashledanou);
